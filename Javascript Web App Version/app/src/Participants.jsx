...
const Participants = ({ }) => {
    ...
    // useEffect => ReactJS hook. It runs a function everytime a value in its dependency array changes (from props or state)
